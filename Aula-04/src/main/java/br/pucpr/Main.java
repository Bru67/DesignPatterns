...
import br.pucpr.user.column.CpfColumn;
import br.pucpr.user.column.EmailColumn;
import br.pucpr.user.column.IdColumn;
import br.pucpr.user.User;
import br.pucpr.user.column.NameColumn;
...
public class Main {
  public static void main(String[] args) {
    ...
    System.out.println("-------------------");
    new Table(new ColumnTableData<User>(usuarios, new IdColumn(), new NameColumn(), new CpfColumn(true), new EmailColumn()), LIGHT, false).print();
